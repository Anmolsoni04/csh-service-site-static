...
const PrivacyPolicyHero: React.FC = () => {
  return (
    <section className="relative min-h-[60vh] flex flex-col items-center justify-center text-center bg-gradient-to-r from-[#0a0f29] via-[#0f163b] to-[#0a0f29] text-white px-6">
      {/* Overlay */}
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        <h1 className="text-44 md:text-5xl font-bold mb-4 leading-tight">
          Our Commitment to Your <span className="text-blue-400">Privacy</span>
        </h1>
