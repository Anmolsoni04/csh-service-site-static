      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 lg:px-20 grid md:grid-cols-2 gap-10 items-center w-full">
        <div className="space-y-6">
          ...
          <h1 className="text-4xl md:text-5xl font-bold leading-tight">
            Modern <span className="text-blue-400">Websites</span> That Inspire
          </h1>
          <p className="text-gray-300 max-w-lg">
            Build responsive, fast, and user-friendly websites designed to make your brand stand out online.
          </p>
        </div>
        <motion.div
