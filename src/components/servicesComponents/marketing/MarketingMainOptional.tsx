...
const services = [
  { title: "Content Marketing", desc: "Engaging blogs, articles, and media for your brand.", img: "https://images.unsplash.com/photo-1551836022-4c4c79ecde51?q=80&w=1200&auto=format&fit=crop" },
  { title: "Email Campaigns", desc: "Personalized emails to nurture customer loyalty.", img: "https://images.unsplash.com/photo-1492724441997-5dc865305da7?q=80&w=1200&auto=format&fit=crop" },
  { title: "PR & Communications", desc: "Build a trustworthy brand image with strong PR.", img: "https://images.unsplash.com/photo-1498050108023-c5249f4df085?q=80&w=1200&auto=format&fit=crop" },
  { title: "Market Analytics", desc: "Insights to measure and refine your campaigns.", img: "https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?q=80&w=1200&auto=format&fit=crop" },
];

const MarketingMainOptional: React.FC = () => {
  const [active, setActive] = useState(0);
  const [prev, setPrev] = useState(0);
  const handleHover = (i: number) => { if (i !== active) { setPrev(active); setActive(i); } };
  ...
  return (
    <section className="relative bg-gradient-to-r from-orange-100 to-white py-20">
      <div className="mx-auto max-w-7xl px-4 grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="absolute inset-0 animate-spin-slow flex items-center justify-center">
              <svg viewBox="0 0 100 100" className="w-full h-full">
                ...
                <text fill="black" fontSize="6">
                  <textPath href="#circlePath"> Marketing • Marketing • Marketing • </textPath>
                </text>
              </svg>
            </div>
            {services.map((s, i) => (
        ...
        <div>
          <h2 className="text-3xl md:text-4xl font-extrabold">Marketing That Inspires and Converts</h2>
...
export default MarketingMainOptional;
